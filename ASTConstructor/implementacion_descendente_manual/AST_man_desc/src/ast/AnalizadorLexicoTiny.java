...
public class AnalizadorLexicoTiny {
   ...
   private GestionErroresTiny errors;
   ...
   public AnalizadorLexicoTiny(Reader input) throws IOException {
    this.input = input;
    this.errors = new GestionErroresTiny();
   ...
   public UnidadLexica sigToken() throws IOException {
     ...
     while(true) {
         ...
         case INICIO:
        	 ...
        	 else errors.errorLexico(this.filaActual,this.columnaActual,(char)sigCar,lex.toString());
        	 break;
         case REC_ID:
...
private void transita(Estado sig) throws IOException {
   ...
   private void saltaFinDeLinea() throws IOException {
      for (int i=1; i < NL.length(); i++) {
          sigCar = input.read();
          if (sigCar != NL.charAt(i)) errors.errorLexico(this.filaActual,this.columnaActual,(char)sigCar,lex.toString());
      }
      sigCar = '\n';
   }
